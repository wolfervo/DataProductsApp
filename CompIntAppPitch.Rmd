...
```{r, echo=FALSE}
ggplot(data=pd, aes(x=time, y=value)) + geom_point(aes(size = value), col = "dark blue") + geom_line(col = "dark blue") + xlab("Years Compounded") + ylab("Investment Value") + ggtitle("Projected Value of Investment Over Time")
```